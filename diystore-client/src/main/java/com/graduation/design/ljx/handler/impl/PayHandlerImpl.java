...
import com.graduation.design.ljx.handler.PayHandler;
...
public class PayHandlerImpl implements PayHandler{
    ...
    @Override
    public DiyStoreProcessorResult<Void> pay(String price, String itemName) {
        AlipayClient alipayClient = PayHandlerImpl.getAlipayClient();
